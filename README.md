...
* It covers a fundamental numpy tutorial on natural language processing. The goal in this tutorial is to create a model from a text, that recreates texts, similar to the input text 
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/schutera/Tutorial-6-Recurrent-Neural-Networks-for-Language-Modelling-and-Generation/HEAD?labpath=NLP-TUT.ipynb)


<!-- ROADMAP -->
## Roadmap

See the [open issues](https://github.com/schutera/Tutorial-6-Recurrent-Neural-Networks-for-Language-Modelling-and-Generation/issues) for a full list of proposed features (and known issues).
